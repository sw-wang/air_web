        ...
        <div class="secondary-content">
            ...
            <div class="input-content">
                <el-form :model="filterForm" ref="filterForm" label-width="90px">
                    <el-row :gutter="10">
                        <el-col :span="6">
                            <el-form-item label="项目编号" prop="search_LIKE_code">
                                <el-input v-model="filterForm.search_LIKE_code" size="small"> </el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="项目名称" prop="search_LIKE_name">
                                <el-input v-model="filterForm.search_LIKE_name" size="small"> </el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="结算状态" prop="search_EQ_status">
                                <el-select filterable v-model="filterForm.search_EQ_status" placeholder="请选择" size="small" style="width: 100%">
                                    <el-option label="全部" value=""> </el-option>
                                    <el-option label="未结算" value="Open"> </el-option>
                                    <el-option label="已结算" value="Close"> </el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
            ...
            <el-table :data="project.page" border stripe style="width: 100%; margin-top: 10px;">
            ...
            <div class="block" style="padding: 10px 0;">
                <el-pagination background layout="total, prev, pager, next" :total="project.total" :current-page.sync="project.curr" @current-change="currentChange"></el-pagination>
            </div>
                        ...
                        <el-row :gutter="10">
                            ...
                            <el-col :span="12">
                                <el-form-item label="结算状态" prop="status">
                                    <el-select filterable v-model="form.status" placeholder="请选择结算状态" size="small" style="width: 100%">
                                        <el-option label="已结算" value="Close"> </el-option>
                                        <el-option label="未结算" value="Open"> </el-option>
                                    </el-select>
                                </el-form-item>
...
<script>
import { projectPage, projectAdd, projectDelete, projectUpdate, projectGet } from '@/services/project'
export default {
    data() {
        return {
            filterForm: {
            ...
            rules: {
                ...
                code: [{ required: true, message: '请输入项目编号', trigger: 'change' }],
                isEnabled: [{ required: true, message: '请选择项目有效性', trigger: 'change' }],
    ...
    methods: {
        getProject() {
            ...
            projectPage(param).then(data => {
                this.project.total = data.totalElements
                this.project.page = data.content
            })
        },
        add() {
