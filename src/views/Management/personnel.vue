        ...
        <div class="secondary-content">
            ...
            <div class="input-content">
                <el-form :model="filterForm" ref="filterForm" label-width="90px">
                    <el-row :gutter="10">
                        <el-col :span="6">
                            <el-form-item label="工号" prop="search_LIKE_code">
                                <el-input clearable v-model="filterForm.search_LIKE_code" size="small"> </el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="姓名" prop="search_LIKE_name">
                                <el-input clearable v-model="filterForm.search_LIKE_name" size="small"> </el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="性别" prop="search_EQ_gender">
                                <el-radio v-model="filterForm.search_EQ_gender" label="">全部</el-radio>
                                <el-radio v-model="filterForm.search_EQ_gender" label="Male">男</el-radio>
                                <el-radio v-model="filterForm.search_EQ_gender" label="Female">女</el-radio>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="部门">
                                <el-select filterable v-model="filterForm['search_EQ_dept.id']" placeholder="请选择" size="small" style="width: 100%">
                        ...
                        <el-col :span="12">
                            <el-form-item label="在职状态" prop="search_EQ_jobStatus">
                                <el-radio v-model="filterForm.search_EQ_jobStatus" label="">全部</el-radio>
                                <el-radio v-model="filterForm.search_EQ_jobStatus" label="OnJob">在职</el-radio>
                                <el-radio v-model="filterForm.search_EQ_jobStatus" label="LeaveJob">离职</el-radio>
                                <el-radio v-model="filterForm.search_EQ_jobStatus" label="Retired">退休</el-radio>
                            </el-form-item>
                        </el-col>
                    </el-row>
            ...
            <el-table :data="emp.page" border stripe style="width: 100%; margin-top: 10px;">
                ...
                <el-table-column prop="jobStatus" label="在职状态">
                    <template slot-scope="scope">
                        {{ jobStatus[scope.row.jobStatus] }}
                    </template>
                </el-table-column>
                <el-table-column prop="isEnabled" label="是否有效">
                    <template slot-scope="scope">
            ...
            <div class="block" style="padding: 10px 0;">
                <el-pagination background layout="total, prev, pager, next" :total="emp.total" :current-page.sync="emp.curr" @current-change="currentChange"></el-pagination>
            </div>
                ...
                <div class="input-content">
                    <el-form ref="form" :rules="rules" :model="form" label-width="90px">
                        <el-row :gutter="10">
                            ...
                            <el-col :span="12">
                                <el-form-item label="部门">
                                    <el-select filterable v-model="form.deptId" placeholder="请选择" size="small" style="width: 100%">
                                        <el-option v-for="item in depts" :key="item.id" :label="item.name" :value="item.id"></el-option>
                                    </el-select>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="职务">
                                    <el-input v-model="form.jobName" size="small"> </el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="在职状态" prop="jobStatus">
                                    <el-radio v-model="form.jobStatus" label="OnJob">在职</el-radio>
                                    <el-radio v-model="form.jobStatus" label="LeaveJob">离职</el-radio>
                                    <el-radio v-model="form.jobStatus" label="Retired">退休</el-radio>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
...
<script>
import { empPage, empDelete, empUpdate, empGet, empAdd } from '@/services/emp'
...
export default {
    data() {
        return {
            ...
            rules: {
                ...
                code: [{ required: true, message: '请输入人员编号', trigger: 'change' }],
                isEnabled: [{ required: true, message: '请选择人员有效性', trigger: 'change' }],
                jobStatus: [{ required: true, message: '请选择在职状态', trigger: 'change' }],
                username: [{ required: true, message: '请填写登录用户名', trigger: 'change' }]
            },
            depts: [],
            dialogVisible: false,
            form: {},
    ...
    methods: {
        getEmps() {
            ...
            empPage(param).then(data => {
                this.emp.total = data.totalElements
                this.emp.page = data.content
            })
        },
        add() {
        ...
        edit(row) {
            ...
            this.form = data
            this.form.deptId = (data.dept && data.dept.id) || ''
            this.dialogVisible = true
        },
        del(row) {
        ...
        save() {
            this.$refs.form.validate(valid => {
                if (valid) {
                    ...
                    /* eslint-disable */
                    this.form.id
                        ? empUpdate(this.form).then(res => {
                              func('更新')
                          })
                        : empAdd(this.form).then(res => {
                              func('新增')
                          })
                }
            })
